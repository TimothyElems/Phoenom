defmodule PhoenomWeb.PostLiveTest do
  use PhoenomWeb.ConnCase

  import Phoenix.LiveViewTest
  import Phoenom.TimelineFixtures

  @create_attrs %{body: "some body", comments: "some comments", username: "some username", likes_count: 42, repost_count: 42}
